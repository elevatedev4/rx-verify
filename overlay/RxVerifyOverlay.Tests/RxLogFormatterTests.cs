...
public class RxLogFormatterTests
{
    ...
    {
        var timing = new RefreshTiming { AttachMs = 40, UiaFindMs = 4, UiaReadMs = 51, CaptureRegionResolveMs = 3, CaptureHideWaitMs = 0, CaptureBlitMs = 53, OcrMs = 105, EngineMs = 180, RenderMs = 8, Phase2Ms = 240 };
    ...
    public void RedactPatient_TimingLineSurvivesEvenWhenAMsValueCollidesWithAPatientDigitToken()
    {
        ...
        var timing = new RefreshTiming { AttachMs = 100, UiaFindMs = 4, UiaReadMs = 51, CaptureRegionResolveMs = 3, CaptureHideWaitMs = 0, CaptureBlitMs = 53, OcrMs = 105, EngineMs = 180, RenderMs = 8 };
